...
export function ratePostByPosts(postToRate, postsToRateBy) {
    ...
    const simAndScore = []; //similarity of each post and its score
    ...
    function happiness(score) {
        ...
        */
        const distPerUnsims = []; //distance per percent unsimilarity
...
export function similarity(postA, postB) {
