...
export class l2TagRater {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //general sample
            const generalSample = new SortedSample(yield getPosts("", 100000, { lookInCache: false, storeInCache: false }));
            ...
            const l1Coms = yield Promise.all(l1ComPromises); //promise.all returns in same order as it was given
            ...
            this.tagData[this.ttrb] = {
                census: new Census(yield getPosts(this.ttrb, 50000, { lookInCache: false, storeInCache: false })),
                com: yield getCommonness(this.ttrb)
            };
    ...
    rateTag(ttr) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const comTtr = yield getCommonness(ttr);
            let numerator = 0;
            let denominator = 0;
            for (const l1Tag of this.l1TagList) {
                if (l1Tag === ttr) {
